...
public class MedtronicReader {
     ...
     * wrong bytes.
     *
     * @param readData , array of bytes read
     * @param read     , length of bytes read
            ...
            if ((opCommand > 0) && (opCommand < 20)) {
                ...
                switch (opCommand) {
                    ...
                    case 0x000C:
                        ...
                        for (int j = 14; j > 0; j--)
                            sb.append(HexDump.toHexString(invertedPage[i + j] & 0x00FF));
                        log.info(sb.toString());
                        i += 14;
                        break;
                    case 0x000D:
    ...
    public String processSensorDataMessage(byte[] readData) {
        ...
        if (HexDump.unsignedByte(expectedSensorSortNumber) == HexDump
            ...
            if (HexDump.unsignedByte(expectedSensorSortNumber) == HexDump
                    ...
                    .unsignedByte(readData[firstMeasureByte + 3])) {
                // sendMessageToUI("Est� dentro de lo esperado ", false);
     ...
     *
     * @param mostRecentData , Record to save.
     ...
     * previously stored.
     *
     * @param measureIndex , index to check
     * @param range        ,
    ...
    class CircleList<E> {
        ...
        /**
         * @param size , maximum number of elements to get.
